    ...
    <div class="content">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <!--        <ul class="list-inline xs-text-center text-white">-->
                                    ...
                                    <!--    <a href="#" class="text-white"><i class="fa fa-phone text-white mr-1"></i><?php echo $contact_no;?></a>-->
                                    <!--</li>-->
                                    <!--<li class="m-0 pl-10 pr-10">-->
                                    <!--    <a href="#" class="text-white"><i class="fa fa-envelope text-white mr-1"></i><?php echo $email;?></a>-->
                                    <!--</li>-->
                        <!--            <li class="m-0 pl-0 pr-10">-->
                        <!--                <a href="https://users.respicite.com/BaseController/registration/bWVyYWs=" class="text-white"><i class="fa fa-edit mr-1"></i><?php echo $msg['register'];?></a>-->
                        <!--            </li>-->
                        <!--        </ul>-->
                        <!--    </div>-->
                        <!--</div>-->
      ...
      <section class="content-header mb-3" style="padding: 6px 0.5rem;background-color: #ffffff;border-bottom: 1px solid #dee2e6;">
        <div class="container">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 pt-2 font-36" style="font-size: 1.2em;color: #000;">Counsellors Profile</h1>
                ...
                <div class="col-12 col-sm-6 text-left">
                    ...
                    <div class='row'>
                        <div class='col-md-12'>
                            ...
                            <div class="form-group"> <?php echo $about_us; ?> </div>
                        </div>
                        <hr>
                        <div class='col-md-12'>
                            <h4>Key Services</h4>
                            ...
                            <div class="mt-4 product-share"> <?php 
                            // if($fb!='')
                            if(!empty($fb))
                                {
                            ...
                            ?> <?php 
                                ...
                                {
                                ?> <a href="
                																							<?php echo $linke; ?>" class="text-gray" style="cursor: pointer;">
              ...
              <div class="row mt-4">
                ...
                <div class="tab-content" id="nav-tabContent">
                 ...
                 $i++;
                  ...
                  echo "No Detail's Added";
                }
                  ?> </div>
                  <!-- <div class="tab-pane fade" id="product-comments" role="tabpanel" aria-labelledby="product-comments-tab"></div> -->
                  <div class="tab-pane show active" id="product-rating" role="tabpanel" aria-labelledby="product-rating-tab">
                    <div class='row p-3'>
                        <div class='col-md-4 p-3 mb-2 basic-drop-shadow border-radius'>
                            <div class="form-group">
