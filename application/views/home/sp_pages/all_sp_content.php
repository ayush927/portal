...
<body class="" data-new-gr-c-s-check-loaded="14.1062.0" data-gr-ext-installed="">
                            ...
                            <div class="sidebar sidebar-left mt-sm-30">
                                <div class="widget border">
                                    ...
                                    <ul class="list list-divider list-border">
                                        <li>
                                            <a class="btn btn-sm relevant-education" href="<?php echo base_url("home/partner-counsellors");?>">Filter Clear</a>                                            
                                        </li>
                                        <li>
                                            <p>Service Name</p>
    ...
    <script>
        ...
        $(document).on("change",".filter-event",function(){
            let segment1 = $("#segment_1");
            let segment2 = $("#segment_2");
            let segment3 = $("#segment_3");
            let segment4 = $("#segment_4");
            let sn = $(this).val();
            console.log(sn, segment1, segment2, segment3, segment4);
            switch($(this).data("name")){
                case "service":
                    window.open(`${BASE_URL}home/partner_counsellors/${sn}/${(segment2 != "")?segment2:null}/${(segment3 != "")?segment3:null}/${(segment4 != "")?segment4:null}`,"_self");
                break;
                case "city":
                    window.open(`${BASE_URL}home/partner_counsellors/${(segment1 != "")?segment1:null}/${sn}/${(segment3 != "")?segment3:null}/${(segment4 != "")?segment4:null}`,"_self");
                break;
                case "days":
                    window.open(`${BASE_URL}home/partner_counsellors/${(segment1 != "")?segment1:null}/${(segment2 != "")?segment2:null}/${sn}/${(segment4 != "")?segment4:null}`,"_self");
                break;
                case "channel":
                    window.open(`${BASE_URL}home/partner_counsellors/${(segment1 != "")?segment1:null}/${(segment2 != "")?segment2:null}/${(segment3 != "")?segment3:null}/${sn}`,"_self");
                break;
            }
        });
    </script>
