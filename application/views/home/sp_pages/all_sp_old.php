...
<head>
    ...
    <meta name="description"
        content="Youth and adults, all genders, disabled, minorities, limited English proficient, dropouts, single parents, teachers, administrators, parents get benefitted from parenting counsellor and career counselling service.">
    <meta name="keywords"
        content="parenting counselor, career counselling services,education,school,university,educational,learn,learning,teaching,workshop">
    <meta name="author" content="respicite">

    <!-- Page Title -->
    <title>Respicite - Solutions for LifeCareer</title>
    ...
    <link id="menuzord-menu-skins" href="https://respicite.com/css/menuzord-skins/menuzord-boxed.css" rel="stylesheet">
    <!-- CSS | Main style file -->
    ...
    <link id="menuzord-menu-skins" href="https://respicite.com/css/menuzord-skins/menuzord-rounded-boxed.css"
        rel="stylesheet">
    <!-- external javascripts -->
    <script src="https://respicite.com/js/jquery-2.2.4.min.js" type="text/javascript"></script>
    <script src="https://respicite.com/js/jquery-ui.min.js" type="text/javascript"></script>
    <script src="https://respicite.com/js/bootstrap.min.js" type="text/javascript"></script>
    <!-- JS | jquery plugin collection for this theme -->
    <script src="https://respicite.com/js/jquery-plugin-collection.js" type="text/javascript"></script>
    <style id="fit-vids-style">
        ...
        .hover-effect{
            box-shadow: 4px 4px 16px 0px #9b9797;
        ...
        .relevant-education,.relevant-education:hover{
        ...
        .btn-submit-modal,.btn-submit-modal:hover,.btn-submit-modal:active{
            background:#fc9928;
            color:white;
        }
    ...
    <div id="wrapper" class="clearfix">
                                ...
                                <ul class="list-inline xs-text-center text-white">
                                    ...
                                    <li class="m-0 pl-10 pr-10">
                                        <a href="#" class="text-white"><i
                                                class="fa fa-envelope-o text-white mr-5"></i>sales@respicite.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <ul class="list-inline sm-pull-none sm-text-center text-right text-white mb-sm-20 mt-10">
                                ...
                                <li class="m-0 pl-0 pr-10">
                                    <a href="https://users.respicite.com/BaseController/registration/bWVyYWs="
                                        class="text-white"><i class="fa fa-edit mr-5"></i>Register</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="main-content">
            ...
            <section class="inner-header divider layer-overlay overlay-theme-colored-7"
                data-bg-img="https://respicite.com/images/1920x820-2.jpg"
                style="background-image: url('https://respicite.com/images/1920x820-2.jpg');">
                <div class="container pt-120 pb-60">
                    <!-- Section Content -->
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-6">
                                <h2 class="text-theme-colored2 font-36">Our Counsellors</h2>
                                <ol class="breadcrumb text-left mt-10 white">

                                    <li><a href="#">Browse, Choose, Get Counselling</a></li>
                            ...
                            <div class="sidebar sidebar-left mt-sm-30">
                                <div class="widget border">
                                    ...
                                    <ul class="list list-divider list-border">
                                        <li>
                                            <a class="btn btn-sm relevant-education" href="<?php echo base_url("home/service-provider");?>">Filter Clear</a>                                            
                                        </li>
                                        <li>
                                            <p>Service Name</p>
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="details-box">
                                                            ...
                                                            <?php for($v_i = 0; $v_i < sizeof($v["locations"]);$v_i++){
                                                               echo "<span class='border border-right'>".$v["locations"][$v_i]."</span>";
                                                            }?>
                                                            <br>
