        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url().'UserController/ap_book_view'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Notifications</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              ?>
              <li class="nav-item">
                <a href="<?php echo base_url().'UserController/otherInformation'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              ?>
              <li class="nav-item">
                <a href="<?php echo base_url().'UserController/expiryModuleConfg'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <?php } if(in_array("video_conferencing", $rr))
                    { ?>
                <li class="nav-item">
                <a href="<?php echo base_url().'UserController/videoConferencing'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Video Conferencing</p>
                </a>
              </li>
              <!-- <li class="nav-item">
                <a href="<?php echo base_url().'SpController/scheduleMetting'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url().'UserController/vocational_live_training_add'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
