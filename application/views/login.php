...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="
							<?php echo base_url().'/assets/plugins/fontawesome-free/css/all.min.css'; ?>">
    <!-- Theme style -->
    ...
    <div class="container" id="container">
    	...
    	<div class="form-container sign-in-container login-tab">
    		<form action="" method="post">
    			...
    			<a href="https://users.respicite.com/UserController/forgot_password">Forgot your password?</a>
    			<!--<button class='submit'>Sign In</button>-->
    			<div class="d-flex outer">
            			<button class='submit mr-5'>Sign In</button>      
            			<a type='button' href="<?= base_url() ?>UserController/registration" id="signUp"  class="ghost">Sign Up</a>
    			</div>
    			<div class='row'>
    			    <div class='col-md-6'>
    			    </div>
