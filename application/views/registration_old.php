...
<?php
  ...
  <div class='container' style='padding-top:60px;'>
      <div class='row text-center' style='padding-top:60px' >
        <div class="col-md-6 text-area" style='padding-top:160px' >
            <?php
                // echo "<pre>"; 
                // $subDomain = 
                // if(  )
        ...
        <div class="offset-md-2 col-md-4 registration_area">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <form action="" method="post">
        ...
        <!--<div class="input-group mb-3">-->
        <!--<select class="form-control d-none <?php echo (form_error('role')!="") ? 'is-invalid' : ''; ?>" name="role" value="<?php echo set_value('role'); ?>" id="role">-->
