    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php if(in_array("overseas_services", $rr)) { ?>
          <li class="nav-item">
            <a href="<?php echo base_url().'SpController/oveses'; ?>" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <a href="#" class="nav-link">
              <i class="nav-icon far fa-envelope"></i>
              <p>Other Services<i class="fas fa-angle-left right"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <?php $rr = explode(",",$allowed_services);
                    if(in_array("other_information", $rr))
                    {
              ?>
              <li class="nav-item">
                <a href="<?php echo base_url().'SpController/otherInformation'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Other Information</p>
                </a>
              </li>
              <?php } $rr = explode(",",$allowed_services);
                    if(in_array("assessment_expiry", $rr))
                    {
              ?>
              <li class="nav-item">
                <a href="<?php echo base_url().'SpController/expiryModuleConfg'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Expiry module Config</p>
                </a>
              </li>
            <?php } if(in_array("video_conferencing", $rr))
                    { ?>
                <li class="nav-item">
                <a href="<?php echo base_url().'SpController/videoConferencing'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Video Conferencing</p>
                </a>
              </li>  
            <?php 
              } if(in_array("overseas_services", $rr)){ 
            ?>
                <li class="nav-item">
                <a href="<?php echo base_url().'SpController/view_sevice_charge'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Overseas Charges</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview"> 
              <li class="nav-item">
                <a href="<?php echo base_url().'SpController/vocational_training_add'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Recorded Training</p>
                </a>
              </li> 
              <li class="nav-item">
                <a href="<?php echo base_url().'SpController/vocational_live_training_add'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add live Training</p>
                </a>
              </li>            
              <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <?php if(in_array("payment_gateways", $rr)) {?>
              <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url().'SpController/addAssociate'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Associate</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'SpController/getAllAssociate'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Associate</p>
                </a>
              </li>
