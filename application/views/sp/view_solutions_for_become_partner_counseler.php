                  ...
                  <p class="text-muted">
                    ...
                    <?php 
                      ...
                      <?php 
                        ...
                        echo 'Onboarding Assessment Failed, Request again for the Onboarding Exam'
                        ?>
                        <a href="<?php echo base_url().'SpController/request_for_retest/'.$d_row->id.'/'.base64_encode($row->c_group); ?>" class="btn btn-primary btn-block"><b>Request for Onboarding Exam</b></a>
                    <?php   }
                    ?>
