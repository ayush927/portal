...
foreach($payment_details as $row){
    if( $row['payment_type_name'] == 'razorypay' ){
        $exist = true;
?>
...
?>
        <div class="col-12 col-lg-6 ">
                    <div class="card bg-cyan" style="min-height: 150px; padding-top:20px;">
                                <div class="card-body">
                                    <a href="<?php echo base_url().'payment-gateway/razorypay/keys'; ?>"  style="text-decoration: none; color:white;">
                                    <div class="row" style="min-height: 130px; ">
                                      <div class="col-5" style="opacity: .7;" >
                                        <img class="bg-cyan" src="<?php echo base_url().'/assets/dist/img/file2.png'; ?>" style="height: 90px; width:90px;"  alt="Card image cap">                
                                      </div>
                                      <div class="col-7" style="opacity: .7; color:black;">
                                      <span><h4><b><?php echo 'Rrazorypay' ?></b></h4></span>
                                      </div> 
                                    </div> 
                                    </a>
                                    ...
                                    <a href="<?php echo base_url().'payment-gateway/razorypay/keys'; ?>"  class='btn btn-primary'>Add Credential</a>
