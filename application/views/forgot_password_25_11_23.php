        ...
        <!-- message -->
          ...
          <p class="mb-1">
            <?php
                if( $code != null ){
            ?>
                    <a href="<?php echo base_url('BaseController/login/'.base64_encode($code));?>" class="text-secondary">Login</a>
                </p>
                <p class="mb-0">
                    <a href="<?php echo base_url('BaseController/registration/'.base64_encode($code));?>" class="text-center text-secondary">Register a new membership</a>
            <?php
