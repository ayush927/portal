...
$sp_logo = $this->Sp_model->get_sp_logo($_SESSION['user']['code']);
    if(!empty($sp_logo)){
      ...
      if(!file_exists($path_logo)){
        ...
        $path_logo = $_SESSION['user']['favicon'];
      }
    }else{
      $path_logo = $_SESSION['user']['favicon'];
    }
...
<meta charset="utf-8">
  ...
  <?php
    if( $path_logo != '' ){
      $path_logo = 'https://respicite.com/images/logo_36.png' ;
    }
  ?>

  <link href="<?= $path_logo ?>" height='16' width='16' rel="shortcut icon" type="image/png">
