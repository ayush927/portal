...
?>
  <section class="content">
      <div class="container-fluid">
        ...
        ?>
        <div class="card card-default <?php echo $row->code != $selected ? 'collapsed-card' : '' ?>">
            ...
            <!-- /.card -->
             ...
             <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
                  <div class="card  h-100 bg-card shadow">
                      ...
                      <div class="card-header">
                        <h3 class="card-title"><?php echo "Update Other Information";?><div class="rounde-box">2</div></h3>
              ...
              <div class="card-body">
                ...
                <?php 
                    if($row->status !=='Ap'){
                        ...
                        ?>
                                        <a class="btn btn-my btn-block"  href="<?php echo base_url().'assets/report-pdf/'.$row->code.'.pdf'; ?>">View Report</a><br>
                        <?php
                                        }
                                        else{
