...
.img-circlues{
  ...
  <aside class="main-sidebar sidebar-dark-primary">
    ...
    <a href="#" class="brand-link user_logo p-1 text-center" >
      ...
      <?php
        ...
        <?php if($email=='0108ritesh@gmail.com'){?> 

                <img src="<?php echo base_url().$logo;  ?>" alt="Reseller Logo" class="img-fluid">
    ...
    <div class="sidebar">
      ...
      <nav>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item border-bottom menu-is-opening menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <?php 
                    ...
                    if($allowed_services !=''){$rr = explode(",",$allowed_services);}

                   

                    if(($rr !='') && (in_array("counselling", $rr))){?>
              ...
              <?php }
                ...
                // pre( explode( ',' , $allowed_services ) );

                if( in_array( 'notifications' , explode( ',' , $allowed_services) ) ){

              ?>

                  <li class="nav-item">

                    <a href="<?php echo base_url().'BaseController/notifications'; ?>" class="nav-link">
        ...
        <li class="nav-item border-bottom">
          ...
          <li class="nav-item border-bottom">
              ...
              <?php 
                if($is_active['trainings']){
              ?>
                    <li class="nav-item border-bottom">
                      <a href="#" class="nav-link bg-light-gray" style='pointer-events: none;'>
                        <i class="nav-icon fas fa-clipboard-list"></i>
                        <p>Skill Development<i class="fas fa-angle-left right"></i></p>
                      </a>
                      <ul class="nav nav-treeview">
                        <li class="nav-item">
