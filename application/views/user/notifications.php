                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                          ...
                          foreach($flow as $row2) { ?>
                            ...
                            <td><?php echo ($row2['payment_status'] =='success' && $row2['mrp'] > 0)?'Paid':'';?></td>
                            <td><div class="row">
                              <div class="col-sm-12">
                                <!-- select -->
                                <div class="form-group">
                                  <input type="hidden" name="rid" id='rid<?php //echo $row->id; ?>' value="<?php //echo $row->id; ?>">
                                      <select class="form-control" name="act" id="act<?php //echo $row->id; ?>" onchange="changeThis(<?php //echo $row->id; ?>)">
                                        ...
                                        <option value="<?php //echo $cst; ?>">Booked</option>
                            ...
                            <?php 
                            if($row2['mrp'] >0 && $row2['payment_status']!=="success")
                            { 
                              ?>
                            <td>
                              <?php 
                              if(isset($paymentGateway[0]['payment_type_name'])=='razorypay')
                              {?>
                              <a class="btn btn-sm btn-outline-success mt-2" href="<?php echo base_url(); ?>shared/payments/RazorpayController/counseling_payment_online/<?php echo $user['email']; ?>/<?php echo $row2['id']; ?>">Make Payment
                              </a>
                              <?php 
                              } else 

                              { ?>
                              <a class="btn btn-sm btn-outline-success mt-2" href="<?php echo base_url(); ?>shared/payments/StripController/stripView">Make Payment
                              </a>
                              <?php 
                              }?>
                              </td>
                              
                              <!--<td><a class="btn btn-sm btn-outline-success mt-2" href="<?php echo base_url(); ?>shared/payments/StripController/stripView">Make Payment</a></td>-->
                              <?php 
                                } 
                                else
                                {
                              ...
                              <td>
                                ...
                                ?>
                                <a class="btn btn-info btn-xs" href="<?php echo $counsling_booking_url.'/'.str_replace(" ","-",strtolower($row2['name'])); ?>/">Booking Counseling</a>
                                <!-- <a class="btn btn-info btn-xs" href="https://calendly.com/iquery-demo<?php echo str_replace(" ","-",strtolower($row2['name'])); ?>/">Booking Counseling</a> -->
                              </td>
                              <?php } ?>
                              <td><button class="btn btn-info btn-xs">Feedback</button>  </td>
                            ...
                            <!--<td><a class="btn btn-info btn-xs" href="<?php echo base_url().'UserController/counselingDelete/'.$row2['id'];?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>   -->
