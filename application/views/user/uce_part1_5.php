           ...
           <p><b><?php echo 'Q. '.$q->qno.'. '.$q->question; ?></b></p>
            ...
            <div class="form-group clearfix">
                            ...
                            <div class="icheck-success">
                              ...
                              <input type="checkbox" name="<?php echo 'radio'.$i.'1'; ?>" value='<?php echo 1; ?>' id="<?php echo $q->qno.'o'.'1'; ?>">
                            ...
                            <div class="icheck-success">
                              ...
                              <input type="checkbox" name="<?php echo 'radio'.$i.'2'; ?>" value='<?php echo 2; ?>' id="<?php echo $q->qno.'o'.'2'; ?>">
                        ...
                        ?>
                            ...
                            <div class="icheck-success">
                              ...
                              <input type="checkbox" name="<?php echo 'radio'.$i.'3'; ?>" value='<?php echo 3; ?>' id="<?php echo $q->qno.'o'.'3'; ?>">
                        ...
                        ?>
                            ...
                            <div class="icheck-success">
                              ...
                              <input type="checkbox" name="<?php echo 'radio'.$i.'4'; ?>" value='<?php echo 4; ?>' id="<?php echo $q->qno.'o'.'4'; ?>">
