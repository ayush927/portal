...
?>
    ...
    <section class="content">
      ...
      <div class="col-sm-12">
           ...
           <p><b><?php echo 'Q. '.$q->qno.'. '.ucfirst(strtolower($q->question)); ?></b></p>
            ...
            <div class="form-group clearfix">
                            <div class="icheck-success">
                              ...
                              <label for="<?php echo $q->qno.'o'.'1'; ?>">
                                ...
                                <?php echo ucfirst(strtolower($q->optionA)); ?>
                            ...
                            <div class="icheck-success">
                              ...
                              <label for="<?php echo $q->qno.'o'.'2'; ?>">
                                ...
                                <?php echo ucfirst(strtolower($q->optionB)); ?>
                        ...
                        ?>
                            ...
                            <div class="icheck-success">
                              ...
                              <label for="<?php echo $q->qno.'o'.'3'; ?>">
                                ...
                                <?php echo ucfirst(strtolower($q->optionC)); ?>
                        ...
                        ?>
                            ...
                            <div class="icheck-success">
                              ...
                              <label for="<?php echo $q->qno.'o'.'3'; ?>">
                                ...
                                <?php echo ucfirst(strtolower($q->optionD)); ?>
