<?php
...

    {
        ...
        public function reportData( $solution, $code)

        {

            $where = "solution='$solution' and code='$code' and status = 1";

            $this->db->where($where);

            return $this->db->get('report_request');
...

        {
            ...
            return $this->db->get('report_request')->result_array();

        }

        public function update_report_status($where , $data)
        ...
        public function getAllAssociate($reseller_id = null) { 

            $this->db->select('*');
            if( $reseller_id != null ){
                $this->db->where('user_id' , $reseller_id );
            }
        ...
        public function getAllCluster() { 
            ...
            $this->db->from('career_apt_latest_2');
         ...
         public function test_cron($data)
        ...
        public function uce_part2_all($num)
        ...
        public function uce_part2_2_all($num)

        {
            ...
            return $this->db->get('uce_part2_2');
        ...
        public function uce_part2_3_all($num)
        ...
        public function uce_part2_4_all($num)
        ...
        public function uce_part2_5_all($num)
        ...
        public function uce_part2_6_all($num)
        ...
        public function getpayment_name($user_id = null)

        {
            ...
            if( $user_id != null ){
                ...
                $this->db->where('payCrd.user_id',$user_id);
        ...
        public function get_questions_ov($num,$tbl, $q_grp=null)
        ...
        {    
            ...
            if($q_grp !=null){$this->db->where('q_grp', $q_grp);}
